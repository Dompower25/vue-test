...
const sunrise = computed(() => {
  return props?.weatherInfo?.sys.sunrise + timeZone.value;
});

const sunset = computed(() => {
  return props?.weatherInfo?.sys.sunset + timeZone.value;
});
</script>
        ...
        <div class="card-small">
          ...
          <div class="card-small-info">
            <div class="card-small-data">
              <div class="info-main-num">{{ props.weatherInfo.wind.gust }}</div>
              <div class="info-main-text">m/s</div>
            </div>
          ...
          <div class="card-info">
            <div class="states">
              <div class="state">
                ...
                <div class="state-time">{{ getTime(sunrise) }}</div>
              </div>
              <div class="state">
                <div class="state-pic state-pic--flipped"></div>
                <div class="state-title">Sunset</div>
                <div class="state-time">{{ getTime(sunset) }}</div>
              </div>
            </div>
          </div>
        </div>
